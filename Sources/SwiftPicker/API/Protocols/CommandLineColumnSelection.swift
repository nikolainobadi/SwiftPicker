...
public protocol CommandLineColumnSelection {
    ...
    /// Displays a dual-column layout with one selectable column and static instructions in the second column.
    ...
    /// Displays a dual-column layout with one selectable column and static instructions in the second column and requires a selection.
    ...
    /// Displays a dual-column layout with multi-selection in the first column and static instructions in the second.
